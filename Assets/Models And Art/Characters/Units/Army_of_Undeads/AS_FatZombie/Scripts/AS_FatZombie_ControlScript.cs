...
public class AS_FatZombie_ControlScript : MonoBehaviour, Mixamo.TransitionHandler
{
//=====================================================================================================
...
//=====================================================================================================
	...
	void Update ()
	{
			...
			{
				asm.ChangeState ( "attack_melee" );
			}
			else if( Input.GetKey( KeyCode.Alpha0 ) )
			{
				asm.ChangeState ( "deform_test" );
			}
	...
	// Upgreads every frame but after Update() and should be used for things that happen based on the effects caused by actions in the Update()
	void LateUpdate() {
